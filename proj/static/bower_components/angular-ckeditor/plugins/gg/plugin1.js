...
var tip="roadmap";
	 switch( data.style )
					...
					var abc = 'http://maps.googleapis.com/maps/api/staticmap?zoom='+data.zoom+'&size='+data.hor+'x'+data.ver+'&maptype='+tip+'&markers=color:red%7Ccolor:red%7Clabel:C%7C'+data.lat+','+data.lon+'&sensor=false';
					editor.insertHtml('<img src='+ abc +'>');
				}
			};
		} );
	}
